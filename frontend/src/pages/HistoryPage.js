                    ...
                    {activeTab === "calendars" ? (
                        <div className="flex items-center gap-3">
                            ...
                            <Select value={filterBy} onValueChange={setFilterBy}>
                                <SelectTrigger className="h-10 w-[150px] rounded-xl border-[#E5E7EB] bg-white text-sm">
                                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-3">
                            <Select value={urlFilterBy} onValueChange={setUrlFilterBy}>
                                <SelectTrigger className="h-10 w-[160px] rounded-xl border-[#E5E7EB] bg-white text-sm">
                                    <div className="flex items-center gap-2">
                                        <Filter className="w-4 h-4 text-gray-500" />
                                        <SelectValue />
